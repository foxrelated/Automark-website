<?php
	...
	*/
	function sanitize($text) 
	{
		...
		{ 
			$text = preg_replace('/^\[e-([^\]]+)\]$/', '<span class="arrowchat_emoji_text arrowchat_emoji_32"><img src="' . $base_url . 'includes/emojis/img/32/$1.png" alt="" data-id="$1.png" /> </span>', $text);
			$text = preg_replace('/\[e-(.*?)\]/', '<span class="arrowchat_emoji_text"><img src="' . $base_url . 'includes/emojis/img/16/$1.png" alt="" data-id="$1.png" /> </span>', $text);
