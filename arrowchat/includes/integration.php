...
session_start();
	...
	*/
	...
	function get_user_id() 
	{
		$userid = NULL;
		//var_dump($_SESSION);
		if (!empty($_SESSION['userAppss']))
		{
			$userid = $_SESSION['userAppss'];
		}
	...
	function get_friend_list($userid, $time)
	{
		...
		$sql = ("
			SELECT DISTINCT " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " userid, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_NAME . " username, arrowchat_status.session_time lastactivity, " . TABLE_PREFIX . DB_USERTABLE . "." . DB_USERTABLE_USERID . " link, arrowchat_status.is_admin, arrowchat_status.status 
