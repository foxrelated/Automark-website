<?php
	...
	*/
	...
	$installs = array(
				...
				"elgg" => array(0 => "Elgg", 1 => "elgg", 2 => "localhost", 3 => "3306", 4 => array("v1.10" => array("Version 1.10+", "/engine/settings.php"), "v1.8" => array("Version 1.8-1.9", "/engine/settings.php"), "v1.7" => array("Version 1.7", "/engine/settings.php"))),
				...
				"xenforo" => array(0 => "XenForo", 1 => "xenforo", 2 => "localhost", 3 => "3306", 4 => array("v1" => array("All Versions", "/library/config.php"))),
