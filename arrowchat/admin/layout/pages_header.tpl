...
<div id="wrapper">
	...
	<div class="breadcrumbs">
		<div class="breadcrumbs_container">
			{if empty($smarty.get.do) or $smarty.get.do eq '/' or $smarty.get.do eq 'delete_history'}Overview{/if}
			{if $smarty.get.do eq 'embedcodes'}Embed Codes{/if}
			{if $smarty.get.do eq 'chatfeatures'}General Features{/if}
			{if $smarty.get.do eq 'chatsettings'}General Settings{/if}
			{if $smarty.get.do eq 'appsettings' or $smarty.get.do eq 'appsedit'}Applications{/if}
			{if $smarty.get.do eq 'traylinks' or $smarty.get.do eq 'traylinksedit'}Bar Links{/if}
			{if $smarty.get.do eq 'chatroomsettings' or $smarty.get.do eq 'chatroomedit' or $smarty.get.do eq 'chatroomlogs'}Chat Rooms{/if}
			{if $smarty.get.do eq 'notificationsettings' or $smarty.get.do eq 'notificationsedit'}Notifications{/if}
			{if $smarty.get.do eq 'manageusers' or $smarty.get.do eq 'logs' or $smarty.get.do eq 'view'}Manage Users{/if}
			{if $smarty.get.do eq 'manageadmins' or $smarty.get.do eq 'actions'}Manage Mods/Admins{/if}
			{if $smarty.get.do eq 'groups' or $smarty.get.do eq 'groupsedit'}Group Permissions{/if}
			{if $smarty.get.do eq 'banusernames'}Ban Usernames{/if}
			{if $smarty.get.do eq 'banip'}Ban IP Addresses{/if}
			{if $smarty.get.do eq 'chatstyle'}General Apperance{/if}
			{if $smarty.get.do eq 'smilies'}Emojis{/if}
			{if $smarty.get.do eq 'templates'}Templates{/if}
			{if $smarty.get.do eq 'managethemes' or $smarty.get.do eq 'install' or $smarty.get.do eq 'edit' or $smarty.get.do eq 'color'}Themes{/if}
			{if $smarty.get.do eq 'adminsettings'}Admin Settings{/if}
			{if $smarty.get.do eq 'configsettings'}Configuration{/if}
			{if $smarty.get.do eq 'language'}Languages{/if}
			{if $smarty.get.do eq 'maintenance' or $smarty.get.do eq 'maintenance2'}Maintenance{/if}
			{if $smarty.get.do eq 'repair'}Repair ArrowChat{/if}
			{if $smarty.get.do eq 'update' or $smarty.get.do eq 'step1' or $smarty.get.do eq 'step2' or $smarty.get.do eq 'step3' or $smarty.get.do eq 'step5'}Update ArrowChat{/if}
		</div>
	</div>
	<div id="content">
		<div id="leftcontent">
				...
				{/if}
				{if $smarty.get.do eq 'managethemes' or $smarty.get.do eq 'smilies' or $smarty.get.do eq 'templates' or $smarty.get.do eq 'chatstyle' or $smarty.get.do eq 'install' or $smarty.get.do eq 'edit' or $smarty.get.do eq 'color'}
				<div class="admin_title_bg"> 
					<ul id ="menu-themes"> 
						...
						<li {if $smarty.get.do eq 'smilies'}class="active_nav"{/if}><a href="themes.php?do=smilies">Emojis</a></li> 
						<li {if $smarty.get.do eq 'templates'}class="active_nav"{/if}><a href="themes.php?do=templates">Templates</a></li> 
						<li {if $smarty.get.do eq 'managethemes' or $smarty.get.do eq 'install' or $smarty.get.do eq 'edit' or $smarty.get.do eq 'color'}class="active_nav"{/if}><a href="themes.php?do=managethemes">Themes{if $themes_have_update} ({$themes_update_count}){/if}</a></li> 
					</ul> 
				</div>
				{/if}
