<?php
	...
	*/
	...
	require_once(dirname(dirname(__FILE__)) . DIRECTORY_SEPARATOR . AC_FOLDER_INCLUDES . DIRECTORY_SEPARATOR . "classes/Smarty/Smarty.class.php");
	...
	$smarty->display(dirname(__FILE__) . DIRECTORY_SEPARATOR . "layout/pages_activate.tpl");
