  ...
  class chatModel extends models{
    ...
    public function __construct(){
      ...
      public function addChatDb($val){
           ...
           $this->_query=$this->_db->prepare("insert into chat (user_id,sender_id,send_id,message_chat,type_chat,status_chat,sub_id,mazad_id) values (?,?,?,?,?,?,?,?)");
      ...
      $sql=$this->_db->query("select * from chat inner join users on (chat.send_id=users.id_u) where  id_chat!='' $add ");
        if($sql){
            $rows=array();
      ...
      public function editStatusChte($array=array()){
			...
			$this->_query=$this->_db->prepare("update chat set status_chat=? where sub_id=? and send_id != ?  ");
    ...
    public function getAll($array=''){
      ...
      $sql=$this->_db->query("select * from chat inner join users on (chat.sender_id=users.id_u) where  id_chat!='' $add ");
        if($sql){
            $rows=array();
