...
<form action="" method="post">
        ...
        <?php }echo ("&nbsp;"); echo ("&nbsp;"); echo ("&nbsp;"); ?>
            ...
            <div class="form-group">
                <input class="car-type-input col-lg-12 col-md-12 col-sm-12 col-xs-12" name="title_ad" type="text"
                       placeholder="<?= _AddAdTitle40characters ?>" maxlength="40"/>
                <input class="price-input col-lg-12 col-md-12 col-sm-12 col-xs-12" type="text" name="price_ad"
                       placeholder="<?= _AskingPriceAED ?>"/>
            </div>
            <div style="width:80%;margin:0 auto" class="form-row">
                ...
                foreach ($data_category as $rows_values) {
                    ...
                    foreach ($_option->getOption(array('id' => $rows_values['option_id'])) AS $rows_option) {
                        if ($lib_func->jsonId($rows_option['option_o'], 'admin') == 1) {
                            continue;
                        }
             ...
             <?php } ?>
                            <?php if ($rows_option['code_o'] == 'plate_number') { ?>
                                <input style="width:45%" class="detail-plate-input col-lg-6" type="text"
                                       ...
                                       value="<?php echo (isset($get[$rows_option['code_o']][0])) ? $get[$rows_option['code_o']][0] : ''; ?>"/>
                            <?php } ?>
                        <?php } ?>
                        <?php if ($lib_func->jsonId($rows_option['option_o'], 'type') == 'select') { ?>
                            <?php if ($rows_option['code_o'] == 'category') { ?>
                                <select style="width:30%;margin-left:1%;margin-right:1%"
                                        class="custom-select d-block col-lg-4"
                                        name="<?php echo $rows_option['code_o']; ?>"
                                        data-placeholder="<?php echo _t(_Category) ?>" tabindex="1">
                            ...
                            <?php if ($rows_option['code_o'] == 'symbol') { ?>
                                <select style="width:23%" class="custom-select d-block col-lg-4"
                                        name="<?php echo $rows_option['code_o']; ?>"
                                        data-placeholder="<?php echo _t(_Symbol) ?>" tabindex="1">
                            ...
                            <?php if ($rows_option['code_o'] == 'the_company_provided_the_service') { ?>
                                <select style="width:49%" class="custom-select d-block col-lg-4"
                                        name="<?php echo $rows_option['code_o']; ?>"
                                        data-placeholder="<?php echo _t(_Thecompanyprovidedtheservice) ?>" tabindex="1">
            ...
            <div class="car-image-head">
                ...
                <div class="basic-details">
                    <ul class="list-inline">
                        <li class="detail col-md-3 hvr-bob"><i class="fa fa-dashboard"></i><span
                                class="detail-km num-bd">95,000</span> <?= _kilometer ?>
                        </li>
                        <li class="detail col-md-3 hvr-bob"><i class="fa fa-calendar fa-1"></i><span
                                class="detail-make num-bd">2012</span></li>
    ...
    <h1><?php var_dump($rows_option['code_o']) ?></h1>
                ...
                for ($i = 0; $i < 4; $i++) {
                    ...
                    <li id="imgThumb<?= $i . $rows_option['id_o'] ?>"
                        ...
                        <button type="button" id="btn<?= $i ?>"
                                onclick="openBrowseDialog('images<?= $i . $rows_option['id_o'] ?>')"><?= _Uploadaphoto ?></button>
                    <span
                        class="help-inline"><?php echo isset($error[$rows_option['code_o']]) ? $error[$rows_option['code_o']] : ''; ?> </span>
                                    ...
                                    <div class="symbol-container">
                                        <select class="custom-select d-block my-3"
                                            ...
                                            <?php foreach ($_option->get_value_option(array('option_id' => $rows_option['id_o'])) as $rowsform):
                                                ...
                                                <?php $valuer = ($rowsform['type_v'] != '' and $rowsform['type_v'] != 0) ? $rowsform['type_v'] : $rowsform['id_v'];?>
                                                <option <?php echo (isset($get[$rows_option['code_o']])) ? $lib_func->selected($get[$rows_option['code_o']], $valuer) : '';?>
                                                    value="<?php echo $valuer; ?>"><?php echo language::getLang($rowsform['value_v']);?><?php echo('&nbsp;') ?><?= _Horsepower ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <i class="fa fa-angle-down fa-lg"></i>
                                    </div>
                                    ...
                                    <div class="symbol-container">
                                        <select class="custom-select d-block my-3"
                                            ...
                                            <?php foreach ($_option->get_value_option(array('option_id' => $rows_option['id_o'])) as $rowsform):
                                                ...
                                                <?php $valuer = ($rowsform['type_v'] != '' and $rowsform['type_v'] != 0) ? $rowsform['type_v'] : $rowsform['id_v'];?>
                                                <option <?php echo (isset($get[$rows_option['code_o']])) ? $lib_func->selected($get[$rows_option['code_o']], $valuer) : '';?>
                                                    value="<?php echo $valuer; ?>"><?php echo language::getLang($rowsform['value_v']);?><?php echo('&nbsp;') ?><?= _kmperho ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <i class="fa fa-angle-down fa-lg"></i>
                                    </div>
                                    ...
                                    <div class="symbol-container">
                                        <select class="custom-select d-block my-3"
                                            ...
                                            <?php foreach ($_option->get_value_option(array('option_id' => $rows_option['id_o'])) as $rowsform):
                                                ...
                                                <?php $valuer = ($rowsform['type_v'] != '' and $rowsform['type_v'] != 0) ? $rowsform['type_v'] : $rowsform['id_v'];?>
                                                <option <?php echo (isset($get[$rows_option['code_o']])) ? $lib_func->selected($get[$rows_option['code_o']], $valuer) : '';?>
                                                    value="<?php echo $valuer; ?>"><?php echo language::getLang($rowsform['value_v']);?><?php echo('&nbsp;') ?><?= _Meter ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <i class="fa fa-angle-down fa-lg"></i>
                                    </div>
                                    ...
                                    <div class="symbol-container">
                                        <select class="custom-select d-block my-3"
                                            ...
                                            <?php foreach ($_option->get_value_option(array('option_id' => $rows_option['id_o'])) as $rowsform):
                                                ...
                                                <?php $valuer = ($rowsform['type_v'] != '' and $rowsform['type_v'] != 0) ? $rowsform['type_v'] : $rowsform['id_v'];?>
                                                <option <?php echo (isset($get[$rows_option['code_o']])) ? $lib_func->selected($get[$rows_option['code_o']], $valuer) : '';?>
                                                    value="<?php echo $valuer; ?>"><?php echo language::getLang($rowsform['value_v']);?><?php echo('&nbsp;') ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                        <i class="fa fa-angle-down fa-lg"></i>
                                    </div>
                        ...
                        foreach ($_option->getOption(array('id' => $rows_values['option_id'])) AS $rows_option) {
                            ...
                            <?php if ($lib_func->jsonId($rows_option['option_o'], 'default') == 1) {
                                if ($rows_option['code_o'] == 'years') {
                                    ?>
                                    <div class="symbol-container">
                                        <select class="custom-select d-block my-3" name="years"
                                                data-placeholder="<?php echo _t(_Choose) ?>" tabindex="1">
                                            <option
                                                value=""><?php echo language::getLang($rows_option['name_o']); ?> </option>
                                            <?php for ($year = date("Y"); $year > 1970; $year--) { ?>
                                                <option  <?php echo (isset($get[$rows_option['code_o']])) ? $lib_func->selected($get[$rows_option['code_o']], $year) : ''; ?>
                                ...
                                if ($rows_option['code_o'] == 'type_c') {
                                    ...
                                    <div class="symbol-container">
                                        <select class="custom-select d-block my-3" name="type_c" tabindex="1"
                                            ...
                                            <?php foreach ($_typecar->getTypeAll(array('category' => $rows_values['category_id'])) as $rowstype): ?>
                                                <option <?php echo (isset($get[$rows_option['code_o']])) ? $lib_func->selected($get[$rows_option['code_o']], $rowstype['id_t']) : ''; ?>
                                    ...
                                    <div class="symbol-container">
                                        <select class="custom-select d-block my-3" name="model" id="subtype"
                                                tabindex="1">
                                            <option
                                                value=""><?php echo language::getLang($rows_option['name_o']); ?> </option>

                                            <?php if (isset($get['model'])) {
                                                foreach ($_typecar->getTypeSubId($get['type_c']) as $rowstypesub): ?>
                                                    <option <?php echo($lib_func->selected($get['model'], $rowstypesub['id_t'])); ?>
                                                        value="<?php echo $rowstypesub['id_t']; ?>"><?php echo language::getLang($rowstypesub['name_t']); ?></option>
                                                <?php endforeach;
                                            } ?>
                                        </select>
                                ...
                                <?php if ($rows_option['code_o'] == 'Country_c') {
                                    ...
                                    ?>
                                    <div class="symbol-container">
                                        <select class="custom-select d-block my-3" name="Country_c"
                                                onchange="return changeselect(this,'city','#subcity') "
                                                data-placeholder="<?php echo _t(_Country) ?>" tabindex="1">
                                            <option value=""><?php echo _t(_Country) ?></option>
                                            <?php foreach ($_city->getCountryAll() as $rowscity): ?>
                                                <option <?php echo (isset($get[$rows_option['code_o']])) ? $lib_func->selected($get[$rows_option['code_o']], $rowscity['id_c']) : ''; ?>
                                                    value="<?php echo $rowscity['id_c']; ?>"><?php echo language::getLang($rowscity['name_c']); ?></option>
                                            <?php endforeach; ?>
                                        </select>
                                    <span
                                        class="help-inline"><?php echo isset($error['Country_c']) ? $error['Country_c'] : ''; ?> </span>
                                        <i class="fa fa-angle-down fa-lg"></i>
                                    </div>
                                    <div class="symbol-container">
                                        <select class="custom-select d-block my-3" name="city" id="subcity"
                                                data-placeholder="<?php echo _t(_City) ?>" tabindex="1">
                                            <option value=""><?php echo _t(_City) ?></option>
                                            <?php if (isset($get['city'])) {
                                                foreach ($_city->getCityId($get['Country_c']) as $rowsc): ?>
                                                    <option <?php echo($lib_func->selected($get['city'], $rowsc['id_c'])); ?>
                                                        value="<?php echo $rowsc['id_c']; ?>"><?php echo language::getLang($rowsc['name_c']); ?></option>
                                                <?php endforeach;
                                            } ?>
                                        </select>
                                    <span
                                        class="help-inline"><?php echo isset($error['city']) ? $error['city'] : ''; ?> </span>
                                        <i class="fa fa-angle-down fa-lg"></i>
                                    </div>
                                <?php }
                            } else {
                    ...
                    foreach ($_option->getOption(array('id' => $rows_values['option_id'])) AS $rows_option) {
                        ...
                        <?php if ($lib_func->jsonId($rows_option['option_o'], 'type') == 'textarea') {
                            if ($rows_option['code_o'] == 'specifications') {
                                ?>
                                <textarea class="col-lg-12" name="<?php echo $rows_option['code_o']; ?>" maxlength="150"
                                          placeholder="<?= _AdditionalInformation150characters ?>"></textarea>
                            <?php }
                        } ?>
                    <?php }
                } ?>
